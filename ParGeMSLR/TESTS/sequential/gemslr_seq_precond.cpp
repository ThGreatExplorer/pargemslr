...
int main (int argc, char *argv[]) 
{
   ...
   for(i = 0 ; i < nmats ; i ++)
   {
      ...
      PARGEMSLR_LOCAL_FIRM_TIME_CALL(PARGEMSLR_TOTAL_SETUP_TIME, (precond.Setup(x, b)));
      
      /*------------------------------------------------
       * 10. Solve phase
       *-----------------------------------------------*/
      
      PARGEMSLR_LOCAL_FIRM_TIME_CALL(PARGEMSLR_TOTAL_SOLVE_TIME, (precond.Solve(x, b)));
